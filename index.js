...
async function fetchHandler(e) {
    ...
    if (!path || path === '' || path === '/') {
        return makeRes(getInfoPage(), 200, { 'content-type': 'text/html; charset=utf-8' })
    }
...
function getInfoPage() {
    return '<!DOCTYPE html><html lang="zh-CN"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1.0"><title>GitHub Token Required</title><style>body{font-family:-apple-system,sans-serif;max-width:600px;margin:80px auto;padding:20px;color:#333}h1{font-size:24px}code{background:#f4f4f4;padding:2px 6px;border-radius:3px;font-size:14px;word-break:break-all}.example{background:#f9f9f9;border-left:3px solid #00bfb3;padding:12px 16px;margin:16px 0}.warn{color:#e36209}</style></head><body><h1>GitHub </h1><p>Token <code>?token=YOUR_TOKEN</code></p><div class="example"><p><strong></strong></p><p><code>https://gh.chinabsd.com/https://github.com/user/repo/releases/download/v1.0/file.zip?token=YOUR_TOKEN</code></p></div><p class="warn"> Token</p></body></html>'
}
